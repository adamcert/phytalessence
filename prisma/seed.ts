...
async function main() {
  ...
  const defaultSettings = [
    { key: 'points_ratio', value: '1', description: 'Points par euro (ex: 1 = 1pt/EUR, 1.5 = 1.5pt/EUR)' },
    ...
    { key: 'notification_message_template', value: 'Félicitations ! Vous avez gagné {points} points sur votre achat Phytalessence.', description: 'Template message notification' },
  ];
